  ...
  return (
    ...
    >
      <div className="container">
        <div className="icon mb-4 pb-2" style={{ width: 130 }}>
        ...
        <ul className="list-unstyled">
          <li className="mb-4 mx-2">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                data-encore-id="icon"
                fill={location.pathname === "/" ? "white" : "#b3b3b3"}
              >
          ...
          <li className="mb-3 mx-2">
            <Link
              ...
              className="text-decoration-none d-flex align-items-center"
              style={{
                color: location.pathname === "/playLists" ? "white" : "#b3b3b3",
              }}
            >
              <svg
                role="img"
                ...
                viewBox="0 0 24 24"
                data-encore-id="icon"
                fill={location.pathname === "/playLists" ? "white" : "#b3b3b3"}
              >
